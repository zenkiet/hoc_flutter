    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(widget.promoList!.promoImage.validate(), fit: BoxFit.fill, height: 240, width: context.width()),
            8.height,
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.promoList!.offer.validate(), style: boldTextStyle(size: 18)),
                4.height,
                Text("22 Dec 2020", style: secondaryTextStyle()),
                16.height,
                Text("Use this Voucher in payment page and enjoy your 30% off", style: primaryTextStyle()),
                16.height,
                Container(
                  padding: EdgeInsets.all(16),
                  color: appStore.isDarkModeOn ? scaffoldSecondaryDark : Color(0xFFfff9ed),
                  child: Row(
                    children: [
                      ...
                      Spacer(),
                      Text("Use", style: boldTextStyle(color: gs_primary_color))
                    ],
                  ),
                ),
                16.height,
